...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('assets/admin/css/solid.min.css') }}">
  <link
...
<body id="page-top">
  ...
  @livewireScripts
  <script src="https://cdnjs.cloudflare.com/ajax/libs/alpinejs/3.12.3/cdn.js"
    integrity="sha512-rYH6kZDWVOr6qyf0X36lEouJsy8LGxGnYv3jFj73nT+nQ8DanG9w9HTsGrv34auOzZYvB0/Xpx+xGK1b76UW4Q=="
    crossorigin="anonymous" referrerpolicy="no-referrer"></script>
  @stack('scripts')
